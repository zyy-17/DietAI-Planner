  ...
  <div class="ai-chat">
    <el-container style="height:calc(100vh - 100px)">
      <el-aside width="260px" class="chat-sidebar">
        ...
        <div v-for="s in sessions" :key="s.id" class="session-item" :class="{ active: currentSessionId === s.id }" @click="loadSession(s.id)">
          <span>{{ s.title }}</span>
        </div>
      </el-aside>
...
.session-item { padding: 10px 12px; cursor: pointer; border-radius: 6px; margin-bottom: 4px; font-size: 14px; color: #606266; }
